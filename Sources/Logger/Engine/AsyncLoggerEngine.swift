...
public protocol AsyncLoggerEngine: Sendable {
    ...
    func write(_ items: Any..., category: LoggerCategory?, logType: LogType, separator: String,
               terminator: String, file: String, line: Int) async
}
...
extension AsyncLoggerEngine {
    ...
    {
        await write(items, category: category, logType: logType, separator: separator, terminator: terminator, file: file, line: line)
    }
}
